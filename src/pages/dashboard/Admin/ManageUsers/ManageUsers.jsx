    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 font-sans">
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <div className="space-y-2 animate-fade-in-down">
          ...
          <p className="text-slate-500 text-lg">Control user roles and manage platform access</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
             ...
             <div className="card glass-panel p-6 relative overflow-hidden group hover:border-emerald-500/30 transition-all duration-300">
                 ...
                 <div className="relative space-y-2">
                     ...
                     <div>
                         ...
                         <p className="text-3xl font-bold text-emerald-600">{stats.totalWorkers}</p>
                     </div>
                 </div>
            </div>

            {/* Buyers */}
             <div className="card glass-panel p-6 relative overflow-hidden group hover:border-blue-500/30 transition-all duration-300">
                 ...
                 <div className="relative space-y-2">
                     ...
                     <div>
                         <p className="text-sm font-medium text-slate-500">Buyers</p>
            ...
            {/* Admins */}
             <div className="card glass-panel p-6 relative overflow-hidden group hover:border-red-500/30 transition-all duration-300">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                     <div>
                        <h2 className="text-xl font-bold text-secondary flex items-center gap-2">
                             <FaUserCog className="text-primary"/> All Users
                        </h2>
                     ...
                     <div className="flex flex-col sm:flex-row gap-3">
                         ...
                         {/* Filter */}
                         <select 
                            className="select select-bordered bg-white focus:outline-none focus:ring-2 focus:ring-primary rounded-xl h-11 font-medium text-slate-600"
                            value={filterRole}
                ...
                <table className="table w-full">
                    <thead className="bg-slate-50 border-b border-slate-100">
                        <tr>
                            ...
                            <th className="px-6 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Update Role</th>
                                ...
                                <tr key={user._id} className="hover:bg-slate-50/50 transition-colors group">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-1.5 font-bold text-slate-700">
                                            <FaCoins className="text-amber-500" /> {user.coin || 0}
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                        <select
                                            ...
                                            value={user.role}
                                            className="select select-sm select-bordered w-full max-w-xs focus:ring-2 focus:ring-primary focus:border-primary rounded-lg"
                                        >
